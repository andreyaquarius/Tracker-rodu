...
Власний API-ключ визначає доступ до Gemini, коли серверний ключ недоступний,
але не обходить тариф. Перед кожною перевіркою гіпотези, індексацією фрагмента
або іншою підтриманою AI-підказкою сервер атомарно резервує один кредит зі
спільного місячного пулу власника проєкту. Якщо кредитів не залишилося, запит
до Gemini не надсилається навіть за наявності власного ключа.
