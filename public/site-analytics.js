...
const PUBLIC_PAGE_TITLES = Object.freeze({
  ...
  "/faq": "Часті запитання — Трекер Роду",
  "/rodove-derevo-onlain": "Родове дерево онлайн — Трекер Роду",
  "/poshuk-predkiv": "Як знайти своїх предків — Трекер Роду",
  "/arkhivni-dokumenty": "Архівні документи для родоводу — Трекер Роду",
  "/posibnyk-z-henealohii": "Посібник із генеалогії — Трекер Роду",
