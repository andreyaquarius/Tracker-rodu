...
7. Роль учасника має бути одним із дозволених role enum.
   Для запису про шлюб використовуй witness_for_bride або witness_for_groom лише тоді,
   коли в документі прямо видно, чию сторону представляє свідок. Не визначай сторону
   за порядком імен, статтю, розташуванням у таблиці чи власним припущенням. Якщо сторону
   не видно, поверни legacy-роль witness, додай учаснику warning про потребу ручного
   уточнення та встанови needsHumanReview=true.
   Так само використовуй sponsor_for_bride або sponsor_for_groom лише коли сторона
   поручителя прямо вказана в документі. Не визначай сторону поручителя за статтю,
   порядком або розташуванням. Якщо сторона не видима, поверни legacy-роль surety,
   додай warning про ручне уточнення та встанови needsHumanReview=true.
