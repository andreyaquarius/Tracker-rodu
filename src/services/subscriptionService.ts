...
export function subscriptionErrorMessage(error: unknown): string {
  ...
  const messages: Record<string, string> = {
    ...
    "PLAN_SECTION_RECORD_LIMIT_REACHED:archive_requests": "Досягнуто ліміт записів у розділі «Запити». Ви можете редагувати або видаляти наявні записи, але не можете додавати нові.",
