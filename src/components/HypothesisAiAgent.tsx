...
const costWarning =
  "На безкоштовному тарифі запит використовує ваш API-ключ Google AI Studio. На платних тарифах спочатку використовується включений місячний ліміт, а після його вичерпання — ваш API-ключ, якщо він збережений.";
