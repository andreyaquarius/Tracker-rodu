const PROJECT_DELETION_PHASE_LABELS: Readonly<Record<string, string>> = {
  ...
  pdf_access_sessions: "Закриваємо тимчасові сесії перегляду PDF",
  finding_document_references: "Очищаємо посилання знахідок на PDF",
  ...
  archive_request_persons: "Очищаємо осіб у запитах",
  ...
  archive_requests: "Видаляємо запити",
  person_relations: "Видаляємо родинні зв’язки",
  document_sources: "Видаляємо зовнішні джерела документів",
