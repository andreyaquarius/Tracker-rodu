  ...
  return (
    ...
    >
      <section className="trial-panel">
        <div>
          <h2>30 днів пробного повного доступу</h2>
          <p>
            Новий користувач отримує 30 днів пробного доступу до повних можливостей.
            Платіжна картка не потрібна. Після завершення пробного періоду акаунт
            переходить на безкоштовний тариф.
          </p>
        </div>
      </section>
