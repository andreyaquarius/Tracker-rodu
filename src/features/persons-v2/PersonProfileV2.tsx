      ...
      >
        {timeline.some((event) => event.relative) ? (
          <p className="detail-text">
            ...
            {" "}Події, що однозначно відбулися до народження або після смерті цієї особи, приховані.
            Якщо дат недостатньо, подія залишається з позначкою «Межі життя не перевірено».
          </p>
        ) : null}
        <PersonTimelineV2
          person={person}
